...
For a detailed walkthrough of the method, multi-variable handling, and parallelization settings (via `options()` or environment variables), please see the full package vignette:
